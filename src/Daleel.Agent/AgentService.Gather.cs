...
public sealed partial class AgentService
{
    ...
    // Product photos are NOT sourced from image search: a paid google_images lookup on a local
    // product name returns 0 results as often as not, and the wrong thumbnail misleads worse than a
    // placeholder disappoints. Images come from SCRAPING the item's own store/brand page (og:image) —
    // see ItemEnrichmentService.FindImageForItemAsync. The former FindProductImageAsync was removed.
