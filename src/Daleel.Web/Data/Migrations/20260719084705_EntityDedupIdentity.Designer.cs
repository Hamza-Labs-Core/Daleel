...
namespace Daleel.Web.Data.Migrations
{
    ...
    [Migration("20260719084705_EntityDedupIdentity")]
    partial class EntityDedupIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Daleel.Web.Data.EnrichmentWorkItem", b =>
                {
                    ...
                    b.ToTable("EnrichmentWorkItems");
                });

            modelBuilder.Entity("Daleel.Web.Data.EntityMergeLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SurvivorName")
                        .IsRequired()
                        .HasMaxLength(400)
                        .HasColumnType("character varying(400)");
            ...
            modelBuilder.Entity("Daleel.Web.Data.EntityRecord", b =>
                {
                    ...
                    b.Property<string>("MergedIntoId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("Daleel.Web.Data.FilteredContentLog", b =>
                {
                    ...
                    b.Property<int?>("AutoRating")
                        .HasColumnType("integer");

                    b.Property<string>("AutoReviewNote")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<long?>("AutoReviewedAt")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("WhitelistEntryId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("AutoReviewedAt");
            ...
            modelBuilder.Entity("Daleel.Web.Data.ImageModerationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ReEvalRequestedAt")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ReEvalRequestedAt");

                    b.HasIndex("Decision", "CreatedAt");

                    b.ToTable("ImageModerationLogs");
                });

            modelBuilder.Entity("Daleel.Web.Data.ImageModerationRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ImageModerationRules");
                });

            modelBuilder.Entity("Daleel.Web.Data.ModerationRuleOverride", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Category", "Term", "Language");

                    b.ToTable("ModerationRules");
                });

            modelBuilder.Entity("Daleel.Web.Data.ModerationWhitelistEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Daleel.Web.Data.RelevanceFlag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("QueryKey", "DedupKey");

                    b.HasIndex("UserHash", "QueryKey", "DedupKey")
                        .IsUnique();

                    b.ToTable("RelevanceFlags");
                });
            ...
            modelBuilder.Entity("Daleel.Web.Data.ServiceCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EncryptedPreviousValue")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Daleel.Web.Data.SiteSearchProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Daleel.Web.Data.WorkContext", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("SynthesisVersion")
                        .HasColumnType("integer");

                    b.Property<long?>("SynthesizedAt")
                        .HasColumnType("bigint");

                    b.Property<int>("SynthesizedFindingCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SearchJobId", "Scope", "Key")
                        .IsUnique();

                    b.ToTable("WorkContexts");
                });
